...
describe("Gerenciador de vagas de estacionamento", () => {
	...
	describe("Fluxo normal", () => {
		...
		test("Listar reservas existentes de vagas de estacionamento para usuários padrão", async()=>{
			const userId = "d6d546d7-f651-4d36-8a28-5f1fe410bdd6"
			...
			await expect(gerenciador.listAll({ userId })).resolves.toBe(reservationMocks)
