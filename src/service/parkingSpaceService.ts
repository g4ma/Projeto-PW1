...
import {
	parkingSpaceValidateZod,
	parkingSpaceValidateZodUpd,
} from "../utils/parkingSpaceValidateZod"
import {
	ParkingSpaceError,
	ParkingSpaceValuesError,
} from "../utils/parkingSpaceError"
...
export class ParkingSpaceService {
	async create({
		...
		try {
			const result = parkingSpaceValidateZod({
				latitude,
				longitude,
				pricePerHour,
				description,
			...
			if (parkingSpace) {
				throw new ParkingSpaceError(
					"parking space at this location already exists"
				)
			}
	...
	async update({
		...
		try {
			...
			const result = parkingSpaceValidateZodUpd({
				pricePerHour,
				disponibility,
				description,
				ownerId,
